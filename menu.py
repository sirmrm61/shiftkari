...
class keyLib:
    ...
    def createMenuForSelectDay(self, year, month, startDay, endDay, idShift=0, totalInRow=7, isEM=2, typeShift=0,
        ...
        for day in range(startDay, endDay):
            ...
            print(cd)
            print(f'''{(isEM == 0)}-{year > int(endDateSelection[0])}-{(year == int(endDateSelection[0]) and month > int(endDateSelection[1]))}-{(year == int(endDateSelection[0]) and month == int(endDateSelection[1]) and day > int(endDateSelection[2]))}''')
