...
/changeMinLicenss 1200000'''
    ...
    choiceDays = 'روزهای مورد نظ خود را انتخاب نمائید📆'
    licenseNeed = '✒️اطلاعات پروانه مورد نیاز خود را با جزئیات وارد نمائید✒️'
    ...
    msgRegistedlicenseEmpty = '📄شما یک آگهی پروانه با ساعات خالی ثبت نموده اید. این آگهی به افرادی که آنرا 📄'
