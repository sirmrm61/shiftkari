...
class messageLib(Enum):
    ...
    afteDelete = 'نام کاربری شما در سامانه غیر فعال گردید برای فعالیت مجدد از دستور start استفاده کنید.'
    ...
    endRegisterShift = 'ثبت شیفت به پایان رسید اطلاعات شیفت برای مسئولان فنی و سپس دانشجویان ارسال خواهد شد.'
    ...
    changeHour = '''برا تغیر زماارسال شیفت ها از دستور ذیل استفاه کنید
/changeHrStudent 24'''
    changeWage = '''برا تغیر حداقل دستمزد از دستور زیر استفاده کنید
/changeMinWage 1200000'''
    changeLicenss = '''برا تغیر حداقل دستمزد پروانه از دستور زیر استفاده کنید
