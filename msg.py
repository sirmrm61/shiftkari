...
class messageLib(Enum):
    ...
    endRegisterShift = 'ثبت شیفت به پایان رسید اطلاعات شیفت برای مسئولان فنی و بعد از {0} در صورت نپذیرفتن توسط مسئولان فنی برای  دانشجویان ارسال خواهد شد.'
...
/changeMinLicenss 1200000'''
    ...
    doseVerify = 'تائید یا عد تائید این کاربر قبلا توسط ادمین انجام شده است.'
